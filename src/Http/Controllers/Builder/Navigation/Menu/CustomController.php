...
use Nabre\Forms\Builder\Navigation\Menu\CustomForm as Form;
use Nabre\Tables\Builder\Navigation\Menu\CustomTable as Table;
...
class CustomController extends Controller
{
    ...
    protected $routeRoot = 'nabre.builder.navigation.menu.custom';
